...
namespace PHPSTORM_META {
  ...
  override(
    ...
    map([
      ...
      'logger.channel.user' => \Drupal\Core\Logger\LoggerChannelInterface::class,
      ...
      'user.flood_control' => \Drupal\user\UserFloodControlInterface::class,
      'user.flood_subscriber' => \Symfony\Component\EventDispatcher\EventSubscriberInterface::class,
      'user.permissions' => \Drupal\user\PermissionHandlerInterface::class,
      'user.toolbar_link_builder' => \Drupal\Core\Security\TrustedCallbackInterface::class,
  ...
  override(
    ...
    map([
      ...
      'user.admin_permissions.module' => \Drupal\Core\Url::class,
      ...
      'user.role.settings' => \Drupal\Core\Url::class,
      'user.role_add' => \Drupal\Core\Url::class,
      'user.well-known.change_password' => \Drupal\Core\Url::class,
    ])
  );
  ...
  override(
    ...
    map([
      ...
      'user.admin_permissions.module' => \Drupal\Core\Link::class,
      ...
      'user.role.settings' => \Drupal\Core\Link::class,
      'user.role_add' => \Drupal\Core\Link::class,
      'user.well-known.change_password' => \Drupal\Core\Link::class,
    ])
  );
